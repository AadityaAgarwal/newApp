...
export default class CyberCourse extends React.Component{
    ...
    addVisible=()=>{
        ...
        db.collection('NewUsers').doc(this.state.docId).update({
          //  CyberVisible:firebase.firestore.FieldValue.increment(1)
          CyberVisible:this.state.visibility+1,
        })
    ...
    componentDidMount(){
        this.fetchVisible()
        console.log(this.state.docId+"Visibility"+this.state)
       console.warn(this.state.visibility)
